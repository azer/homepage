...
const blocks = [
  ...
  `Previously, I worked for startups in San Francisco when lived in Oakland, California. This was one of the most important experiences of my life, as I learnt a lot about the tech industry.`,
