...
# <a name="what-is-elm"></a> 1. What is Elm?
...
# <a name="language"></a> 2. The Language

Please open up `elm-repl` in your console while you're going through following sections. Use backslash (`\`) before starting new line
in the repl.

## <a name="functions"></a> Functions

Elm is a functional language, so we start learning the language from functions. Here is how we define a
...
Let's define a function that tells if given number is above 100:
...
We can use type aliases for describing what keys and types of values a record has:
...
# <a name="build"></a> 3. Let's Build Apps!
